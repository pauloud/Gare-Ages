...
--
-- Host: localhost:3306
-- Generation Time: Mar 25, 2021 at 03:38 PM
...
INSERT INTO `gare` (`id_gare`, `nom_gare`, `ville_gare`) VALUES
(1, 'Paris Nord', 'Paris'),
(2, 'Paris Est', 'Paris'),
(3, 'Reims', 'Reims'),
(4, 'Paris Bercy', 'Paris'),
...
INSERT INTO `ville` (`id_v`, `nom`, `region`, `population`, `chomage`, `description`) VALUES
