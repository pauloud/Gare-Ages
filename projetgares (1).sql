...
(1, 'GUEYE', 'MAME', '25 RUE ERNEST MICHEL', '+33761529428', 'aezdfsevd', 'sss'),
(2, 'GUEYE', 'MAME', '25 RUE ERNEST MICHEL', '+33761529428', '25 RUE ERNEST MICHEL', 'sss');
...
(1, 'Montpellier', 34, 277639, 21.3),
(2, 'Marne la vallée', 77, 277639, 11),
(3, 'Lyon', 69, 516092, 25.6),
(4, 'Paris', 75, 2187000, 11.9),
(5, 'Lille', 59, 190546, 8),
(6, 'Grenoble', 38, 161616, 6.8),
(7, 'Avignon', 84, 93306, 9.6),
(8, 'Nancy', 54, 105162, 7.2),
(9, 'Perpignan', 66, 102191, 12.7);
...
--
ALTER TABLE `ville`
  MODIFY `id_v` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
COMMIT;
