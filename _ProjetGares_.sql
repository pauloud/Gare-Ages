...
--
ALTER TABLE `ANTENNE`
  ADD CONSTRAINT `antenne_ibfk_1` FOREIGN KEY (`ID_V`) REFERENCES `VILLE` (`ID_V`),
  ADD CONSTRAINT `antenne_ibfk_2` FOREIGN KEY (`ID_O`) REFERENCES `ORGANISATION` (`ID_O`);

--
-- Constraints for table `GARE`
--
ALTER TABLE `GARE`
  ADD CONSTRAINT `cle_etrangere_ville` FOREIGN KEY (`VILLE`) REFERENCES `VILLE` (`ID_V`);

--
-- Constraints for table `HABITE`
--
ALTER TABLE `HABITE`
  ADD CONSTRAINT `habite_ibfk_1` FOREIGN KEY (`ID_U`) REFERENCES `UTILISATEUR` (`ID_U`),
  ADD CONSTRAINT `habite_ibfk_2` FOREIGN KEY (`ID_V`) REFERENCES `VILLE` (`ID_V`);

--
-- Constraints for table `UTILISATEUR`
--
ALTER TABLE `UTILISATEUR`
  ADD CONSTRAINT `cle_etrangere_organisation` FOREIGN KEY (`ORGANISATION`) REFERENCES `ORGANISATION` (`ID_O`);
